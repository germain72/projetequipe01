package spring01web.controller;
...
import spring01web.services.IServiceListeCourses;
...
//affichertestliste
		@RequestMapping(value="/affichertestliste", method = RequestMethod.GET)    
		public String testliste(final ModelMap pModel) {
